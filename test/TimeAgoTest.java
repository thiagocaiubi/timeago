...
public class TimeAgoTest {
	...
	public void testMinuto(){
		...
		Assert.assertEquals("1 minuto atrás", timeAgo.toString());
	}
	...
	public void test2Minutos(){
		...
		TimeAgo timeAgo = new TimeAgo(time);
		Assert.assertEquals("2 minutos atrás", timeAgo.toString());
	}
	...
	public void test59Minutos(){
		...
		TimeAgo timeAgo = new TimeAgo(time);
		Assert.assertEquals("59 minutos atrás", timeAgo.toString());
	}
	...
	public void testHora(){
		...
		TimeAgo timeAgo = new TimeAgo(time);
		Assert.assertEquals("1 hora atrás", timeAgo.toString());
	}
	...
	public void test2Horas(){
		...
		TimeAgo timeAgo = new TimeAgo(time);
		Assert.assertEquals("2 horas atrás", timeAgo.toString());
	}
	...
	public void test23Horas(){
		...
		TimeAgo timeAgo = new TimeAgo(time);
		Assert.assertEquals("23 horas atrás", timeAgo.toString());
	}
	...
	public void testDia(){
		...
		time.add(Calendar.HOUR, -24);
		TimeAgo timeAgo = new TimeAgo(time);
		Assert.assertEquals("1 dia atrás", timeAgo.toString());
	}
	...
	public void testDoisDiasAtras(){
		...
		TimeAgo timeAgo = new TimeAgo(time);
		Assert.assertEquals("2 dias atrás", timeAgo.toString());
	}
}